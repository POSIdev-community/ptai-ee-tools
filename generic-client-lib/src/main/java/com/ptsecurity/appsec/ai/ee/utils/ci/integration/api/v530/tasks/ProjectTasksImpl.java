...
import com.ptsecurity.appsec.ai.ee.server.v530.api.ApiException;
import com.ptsecurity.appsec.ai.ee.server.v530.api.model.*;
import com.ptsecurity.appsec.ai.ee.utils.ci.integration.api.AbstractApiClient;
import com.ptsecurity.appsec.ai.ee.utils.ci.integration.api.v530.converters.AiProjConverter;
...
import static com.ptsecurity.appsec.ai.ee.server.v530.api.model.LegacyProgrammingLanguageGroup.*;
...
public class ProjectTasksImpl extends AbstractTaskImpl implements ProjectTasks, LatestAstResultBranchTask {
        ...
        ProjectModel projectModel = call(
                () -> {
                    try {
                        ...
                        log.trace("PT AI v.5.3.0 API returns HTTP status 204 if there's no project with given name {}", name);
        ...
        String result = call(
                () -> {
                    try {
                        ...
                        log.trace("PT AI v.5.3.0 API returns HTTP status 400 if there's no project with given Id {}", id);
    ...
    public UUID getLatestCompleteAstResult(@NonNull UUID id) throws GenericException {
        ...
        List<ScanResultModel> scanResults = call(
                () -> client.getBranchesApi().apiBranchesBranchIdScanResultsGet(branchId),
    ...
    public List<Pair<UUID, String>> listProjects() throws GenericException {
        ...
        List<ProjectModel> projects = call(
                () -> client.getProjectsApi().apiProjectsGet(/* limit = */ -1, /* offset = */ -1),
                "PT AI project list read failed");
