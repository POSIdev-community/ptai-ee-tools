...
import com.ptsecurity.appsec.ai.ee.server.v4110.api.model.ProgrammingLanguageGroup;
import com.ptsecurity.appsec.ai.ee.server.v4110.api.model.ScanModuleType;
import com.ptsecurity.appsec.ai.ee.server.v4110.api.model.UserReportFiltersModel;
import lombok.extern.slf4j.Slf4j;

import java.util.*;

import static com.ptsecurity.appsec.ai.ee.server.v4110.api.model.ScanModuleType.*;
...
public class ReportsConverter {
    ...
    private static void applyLanguageFilters(UserReportFiltersModel apiModel, Reports.IssuesFilter uniqModel) {
        List<ProgrammingLanguageGroup> allLanguages = Arrays.asList(
                ProgrammingLanguageGroup.JAVA,
                ProgrammingLanguageGroup.CSHARP,
                ProgrammingLanguageGroup.VB,
                ProgrammingLanguageGroup.PHP,
                ProgrammingLanguageGroup.JAVASCRIPT,
                ProgrammingLanguageGroup.PYTHON,
                ProgrammingLanguageGroup.OBJECTIVEC,
                ProgrammingLanguageGroup.SWIFT,
                ProgrammingLanguageGroup.CANDCPLUSPLUS,
                ProgrammingLanguageGroup.GO,
