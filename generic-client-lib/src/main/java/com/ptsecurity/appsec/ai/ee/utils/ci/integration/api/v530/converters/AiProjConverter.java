...
public class AiProjConverter {
    ...
    public static AnalysisRulesUpdateSettingsModel apply(
        ...
        List<String> pmGroupNames = Optional.ofNullable(settings.getPmTaintSettings())
                .map(UnifiedAiProjScanSettings.PmTaintSettings::getPmGroups)
                .orElse(Collections.emptyList());

        for (String groupName : pmGroupNames) {
