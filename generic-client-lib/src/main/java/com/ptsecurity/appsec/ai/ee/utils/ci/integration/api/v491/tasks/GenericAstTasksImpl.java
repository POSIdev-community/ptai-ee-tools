...
import com.ptsecurity.appsec.ai.ee.utils.ci.integration.api.v491.ApiClient;
import com.ptsecurity.appsec.ai.ee.utils.ci.integration.api.v491.converters.EnumsConverter;
import com.ptsecurity.appsec.ai.ee.utils.ci.integration.api.v491.converters.IssuesConverter;
import com.ptsecurity.appsec.ai.ee.utils.ci.integration.api.v491.converters.ScanErrorsConverter;
...
import static com.ptsecurity.appsec.ai.ee.utils.ci.integration.api.v491.converters.IssuesConverter.convert;
...
public class GenericAstTasksImpl extends AbstractTaskImpl implements GenericAstTasks {
    ...
    public void waitForComplete(@NonNull ScanBrief scanBrief) throws InterruptedException {
        ...
        com.ptsecurity.appsec.ai.ee.utils.ci.integration.api.v491.tasks.GenericAstTasksImpl.ProjectPollingThread pollingThread = new com.ptsecurity.appsec.ai.ee.utils.ci.integration.api.v491.tasks.GenericAstTasksImpl.ProjectPollingThread(client, scanBrief, queue);
