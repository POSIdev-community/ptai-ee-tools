package com.ptsecurity.appsec.ai.ee.utils.ci.integration.api.v4100.tasks;
...
import com.ptsecurity.appsec.ai.ee.utils.ci.integration.api.v4100.ApiClient;
import com.ptsecurity.appsec.ai.ee.utils.ci.integration.api.v4100.converters.EnumsConverter;
import com.ptsecurity.appsec.ai.ee.utils.ci.integration.api.v4100.converters.IssuesConverter;
import com.ptsecurity.appsec.ai.ee.utils.ci.integration.api.v4100.converters.ScanErrorsConverter;
...
import static com.ptsecurity.appsec.ai.ee.utils.ci.integration.api.v4100.converters.IssuesConverter.convert;
...
public class GenericAstTasksImpl extends AbstractTaskImpl implements GenericAstTasks {
    ...
    public void waitForComplete(@NonNull ScanBrief scanBrief) throws InterruptedException {
        ...
        GenericAstTasksImpl.ProjectPollingThread pollingThread = new GenericAstTasksImpl.ProjectPollingThread(client, scanBrief, queue);
