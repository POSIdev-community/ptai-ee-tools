...
@Slf4j
public class AiProjV16ScanSettings extends UnifiedAiProjScanSettings {
    ...
    public AiProjV16ScanSettings(@NonNull final JsonNode rootNode) {
        super(rootNode);
    }

    @Override
    public @NonNull String getJsonSchema() {
        return ResourcesHelper.getResourceString("aiproj/schema/aiproj-v1.6.json");
    }
    ...
    public String getBranchName() {
        log.trace("No branch name support for AIPROJ schema v.1.6");
        return null;
    }

    @Override
    public @NonNull ScanBrief.ScanSettings.Language getProgrammingLanguage() {
        log.trace("No common ProgrammingLanguage support for AIPROJ schema v.1.6");
    ...
    public String getCustomParameters() {
        log.trace("No common CustomParameters flag support for AIPROJ schema v.1.6");
        return null;
    }

    @Override
    public UnifiedAiProjScanSettings setCustomParameters(String parameters) {
        log.trace("No common PublicAnalysisMethod flag support for AIPROJ schema v.1.6");
        return this;
    }
    ...
    public @NonNull Boolean isApplyAllPMRules() {
        log.trace("No ApplyAllPMRules rules support for AIPROJ schema v.1.6");
        return false;
    }

    @Override
    public @NonNull Boolean isUseCustomYaraRules() {
        log.trace("No custom SAST rules support for AIPROJ schema v.1.6");
        return false;
    }
    ...
    public @NonNull Boolean isDownloadDependencies() {
        log.trace("No common DownloadDependencies flag support for AIPROJ schema v.1.6");
        return false;
    }
