...
@Slf4j
public class AiProjV17ScanSettings extends UnifiedAiProjScanSettings {
    ...
    static {
        PROGRAMMING_LANGUAGE_MAP.put(ProgrammingLanguage____.JAVA.value(), ScanBrief.ScanSettings.Language.JAVA);
        PROGRAMMING_LANGUAGE_MAP.put(ProgrammingLanguage____.C_SHARP_WINDOWS_LINUX.value(), ScanBrief.ScanSettings.Language.CSHARP);
        PROGRAMMING_LANGUAGE_MAP.put(ProgrammingLanguage____.C_SHARP_WINDOWS.value(), ScanBrief.ScanSettings.Language.CSHARPWINONLY);
        PROGRAMMING_LANGUAGE_MAP.put(ProgrammingLanguage____.PHP.value(), ScanBrief.ScanSettings.Language.PHP);
        PROGRAMMING_LANGUAGE_MAP.put(ProgrammingLanguage____.JAVA_SCRIPT.value(), ScanBrief.ScanSettings.Language.JAVASCRIPT);
        PROGRAMMING_LANGUAGE_MAP.put(ProgrammingLanguage____.PYTHON.value(), ScanBrief.ScanSettings.Language.PYTHON);
        PROGRAMMING_LANGUAGE_MAP.put(ProgrammingLanguage____.OBJECTIVE_C.value(), ScanBrief.ScanSettings.Language.OBJECTIVEC);
        PROGRAMMING_LANGUAGE_MAP.put(ProgrammingLanguage____.SWIFT.value(), ScanBrief.ScanSettings.Language.SWIFT);
        PROGRAMMING_LANGUAGE_MAP.put(ProgrammingLanguage____.C_AND_C_PLUS_PLUS.value(), ScanBrief.ScanSettings.Language.CPP);
        PROGRAMMING_LANGUAGE_MAP.put(ProgrammingLanguage____.GO.value(), ScanBrief.ScanSettings.Language.GO);
        PROGRAMMING_LANGUAGE_MAP.put(ProgrammingLanguage____.KOTLIN.value(), ScanBrief.ScanSettings.Language.KOTLIN);
        PROGRAMMING_LANGUAGE_MAP.put(ProgrammingLanguage____.SQL.value(), ScanBrief.ScanSettings.Language.SQL);
        PROGRAMMING_LANGUAGE_MAP.put(ProgrammingLanguage____.RUBY.value(), ScanBrief.ScanSettings.Language.RUBY);
        PROGRAMMING_LANGUAGE_MAP.put(ProgrammingLanguage____.SOLIDITY.value(), ScanBrief.ScanSettings.Language.SOLIDITY);
    ...
    public AiProjV17ScanSettings(@NonNull final JsonNode rootNode) {
        super(rootNode);
    }

    @Override
    public @NonNull String getJsonSchema() {
        return ResourcesHelper.getResourceString("aiproj/schema/aiproj-v1.7.json");
    }
    ...
    public @NonNull ScanBrief.ScanSettings.Language getProgrammingLanguage() {
        log.trace("No common ProgrammingLanguage support for AIPROJ schema v.1.7");
    ...
    public String getCustomParameters() {
        log.trace("No common CustomParameters flag support for AIPROJ schema v.1.7");
        return null;
    }

    @Override
    public UnifiedAiProjScanSettings setCustomParameters(String parameters) {
        log.trace("No common PublicAnalysisMethod flag support for AIPROJ schema v.1.7");
        return this;
    }
    ...
    public @NonNull Boolean isDownloadDependencies() {
        log.trace("No common DownloadDependencies flag support for AIPROJ schema v.1.7");
        return false;
    }
