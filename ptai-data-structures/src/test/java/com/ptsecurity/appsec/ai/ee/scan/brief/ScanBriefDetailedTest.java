...
public class ScanBriefDetailedTest extends BaseTest {
    ...
    @Test
    @DisplayName("Convert PT AI 4.1.1, 4.2.0, 4.3.0, 4.4.1, 4.5.0, 4.6.0, 4.7.0, 4.7.1, 4.7.2, 4.8.0, 4.8.1, 4.9.0, 4.9.1, 4.10.0, 4.11.0 scan results")
    @SneakyThrows
            ...
            for (ScanBrief.ApiVersion version : ScanBrief.ApiVersion.values()) {
                ...
                for (ProjectTemplate.ID templateId : ID.values()) {
                    ...
                    if (version == ScanBrief.ApiVersion.V470 || version == ScanBrief.ApiVersion.V471 ||
                            ...
                            version == ScanBrief.ApiVersion.V4110) {
                        continue;
                    }
