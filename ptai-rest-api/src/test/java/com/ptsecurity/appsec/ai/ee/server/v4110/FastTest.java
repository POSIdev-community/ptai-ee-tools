...
import com.ptsecurity.appsec.ai.ee.server.v4110.api.ApiException;
...
@Slf4j
@DisplayName("Test PT AI 4.11.0 REST API calls that do not require scan")
@Tag("integration")
@Environment(enabledFor = { V4110 })
public class FastTest extends com.ptsecurity.appsec.ai.ee.server.v4110.AbstractTest {
    @BeforeAll
