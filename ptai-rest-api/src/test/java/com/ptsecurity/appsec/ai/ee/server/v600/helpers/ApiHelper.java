package com.ptsecurity.appsec.ai.ee.server.v600.helpers;

import com.ptsecurity.appsec.ai.ee.server.helpers.AbstractApiHelper;
import com.ptsecurity.appsec.ai.ee.server.v600.api.ApiClient;
...
import com.ptsecurity.appsec.ai.ee.server.v600.auth.model.AuthScope;
...
public class ApiHelper extends AbstractApiHelper {
    ...
    public final static AuthApi AUTH = new AuthApi(new com.ptsecurity.appsec.ai.ee.server.v600.auth.ApiClient());
