...
import static com.ptsecurity.appsec.ai.ee.server.v500.helpers.ApiHelper.PROJECTS;
import static com.ptsecurity.appsec.ai.ee.server.v500.helpers.ApiHelper.STORE;
...
public abstract class AbstractTest extends BaseTest {
    ...
    protected static void createTestProject() {
        ...
        DefaultProjectSettingsModel defaultProjectSettings = call(
                ApiHelper.PROJECTS::apiProjectsDefaultSettingsGet,
                "Get default project settings API call failed");


        log.trace("Test project creation");
        BaseCreateProjectModel projectSettings = new BaseCreateProjectModel()
        ...
        // TODO
        call(
                () -> STORE.apiStoreProjectIdSourcesPost(
                        PROJECT_ID,
                        true,
                        "",
                        "", getTemplate(PHP_SMOKE).getZip().toFile()),
