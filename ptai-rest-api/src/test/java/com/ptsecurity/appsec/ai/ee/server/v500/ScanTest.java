...
import static com.ptsecurity.appsec.ai.ee.server.v500.api.model.Stage.*;
import static com.ptsecurity.appsec.ai.ee.server.v500.helpers.ApiHelper.*;
import static com.ptsecurity.misc.tools.helpers.CallHelper.call;
import static org.junit.jupiter.api.Assertions.*;

@Slf4j
@DisplayName("Test PT AI 5.0.0 REST API calls that require scan")
@Tag("integration")
@Tag("scan")
@Environment(enabledFor = { V500 })
public class ScanTest extends com.ptsecurity.appsec.ai.ee.server.v500.AbstractTest {
    protected static UUID SCAN_RESULT_ID;

    @BeforeAll
    public static void init() {
        com.ptsecurity.appsec.ai.ee.server.v500.AbstractTest.init();
        com.ptsecurity.appsec.ai.ee.server.v500.AbstractTest.authenticate();
        com.ptsecurity.appsec.ai.ee.server.v500.AbstractTest.createTestProject();
        scan();
    }
