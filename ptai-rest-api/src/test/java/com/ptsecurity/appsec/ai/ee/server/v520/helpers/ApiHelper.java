package com.ptsecurity.appsec.ai.ee.server.v520.helpers;

import com.ptsecurity.appsec.ai.ee.server.helpers.AbstractApiHelper;
import com.ptsecurity.appsec.ai.ee.server.v520.api.ApiClient;
...
import com.ptsecurity.appsec.ai.ee.server.v520.auth.model.AuthScope;
...
public class ApiHelper extends AbstractApiHelper {
    ...
    public final static AuthApi AUTH = new AuthApi(new com.ptsecurity.appsec.ai.ee.server.v520.auth.ApiClient());
