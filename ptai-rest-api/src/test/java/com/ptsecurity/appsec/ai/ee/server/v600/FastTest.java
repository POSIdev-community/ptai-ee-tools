package com.ptsecurity.appsec.ai.ee.server.v600;
...
import static com.ptsecurity.appsec.ai.ee.scan.result.ScanBrief.ApiVersion.V600;
...
import static com.ptsecurity.appsec.ai.ee.server.v600.helpers.ApiHelper.*;
import static org.apache.http.HttpStatus.SC_BAD_REQUEST;
import static org.junit.jupiter.api.Assertions.*;

@Slf4j
@DisplayName("Test PT AI 6.0.0 REST API calls that do not require scan")
@Tag("integration")
@Environment(enabledFor = {V600})
