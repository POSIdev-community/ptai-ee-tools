package com.ptsecurity.appsec.ai.ee.server.v520;
...
import com.ptsecurity.appsec.ai.ee.server.v520.api.ApiException;
...
import com.ptsecurity.appsec.ai.ee.server.v520.helpers.ApiHelper;
...
import static com.ptsecurity.appsec.ai.ee.scan.result.ScanBrief.ApiVersion.V520;
...
import static com.ptsecurity.appsec.ai.ee.server.v520.helpers.ApiHelper.*;
import static org.apache.http.HttpStatus.SC_BAD_REQUEST;
import static org.junit.jupiter.api.Assertions.*;

@Slf4j
@DisplayName("Test PT AI 5.2.0 REST API calls that do not require scan")
@Tag("integration")
@Environment(enabledFor = { V520 })
