package com.ptsecurity.appsec.ai.ee.server.v480;

import com.ptsecurity.appsec.ai.ee.server.integration.rest.Environment;
import com.ptsecurity.appsec.ai.ee.server.v480.auth.ApiClient;
import com.ptsecurity.appsec.ai.ee.server.v480.auth.ApiException;
...
import static com.ptsecurity.appsec.ai.ee.scan.result.ScanBrief.ApiVersion.V480;
...
@Slf4j
@Tag("integration")
@Environment(enabledFor = { V480 })
@DisplayName("Test PT AI 4.8.0 authentication calls")
