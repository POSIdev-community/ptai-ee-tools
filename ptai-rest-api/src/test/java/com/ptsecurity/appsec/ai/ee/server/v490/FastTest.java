...
import com.ptsecurity.appsec.ai.ee.server.v490.api.ApiException;
...
@Slf4j
@DisplayName("Test PT AI 4.9.0 REST API calls that do not require scan")
@Tag("integration")
@Environment(enabledFor = { V490 })
public class FastTest extends com.ptsecurity.appsec.ai.ee.server.v490.AbstractTest {
    @BeforeAll
