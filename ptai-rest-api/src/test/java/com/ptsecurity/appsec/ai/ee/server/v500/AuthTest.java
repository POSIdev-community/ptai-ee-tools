...
import com.ptsecurity.appsec.ai.ee.server.v500.auth.ApiClient;
import com.ptsecurity.appsec.ai.ee.server.v500.auth.ApiException;
...
@DisplayName("Test PT AI 5.0.0 authentication calls")
public class AuthTest extends BaseTest {
    ...
    public void authenticateSuccess() {
        ...
        AuthResultModel authResult = assertDoesNotThrow(auth::apiAuthSigninGet);
    ...
    public void authenticateFailInvalidToken() {
        ...
        try {
            AuthResultModel authResult = auth.apiAuthSigninGet();
    ...
    public void authenticateFailInactiveHost() {
        ...
        assertThrows(ApiException.class, auth::apiAuthSigninGet);
    }
