package com.ptsecurity.appsec.ai.ee.server.v500;
...
import com.ptsecurity.appsec.ai.ee.server.v500.api.ApiException;
import com.ptsecurity.appsec.ai.ee.server.v500.api.model.*;
...
import com.ptsecurity.appsec.ai.ee.server.v500.helpers.ApiHelper;
...
import static com.ptsecurity.appsec.ai.ee.scan.result.ScanBrief.ApiVersion.V500;
...
import static com.ptsecurity.appsec.ai.ee.server.v500.helpers.ApiHelper.*;
import static org.apache.http.HttpStatus.SC_BAD_REQUEST;
import static org.junit.jupiter.api.Assertions.*;

@Slf4j
@DisplayName("Test PT AI 5.0.0 REST API calls that do not require scan")
@Tag("integration")
@Environment(enabledFor = { V500 })
public class FastTest extends com.ptsecurity.appsec.ai.ee.server.v500.AbstractTest {
    @BeforeAll
    ...
    public void checkProjectNotExist() {
        ...
        log.trace("Check that PT AI v.4.11.0 API returns HTTP status 400 if there's no project with given Id");
    ...
    public void readWriteProjectSastSettings() {
        ...
        ProjectSettingsUpdateModel updatedSettings = new ProjectSettingsUpdateModel()
