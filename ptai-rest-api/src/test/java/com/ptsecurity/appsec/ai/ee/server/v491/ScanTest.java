package com.ptsecurity.appsec.ai.ee.server.v491;
...
import com.ptsecurity.appsec.ai.ee.server.v491.helpers.ApiHelper;
...
import static com.ptsecurity.appsec.ai.ee.scan.result.ScanBrief.ApiVersion.V491;
...
import static com.ptsecurity.appsec.ai.ee.server.v491.api.model.Stage.*;
import static com.ptsecurity.appsec.ai.ee.server.v491.helpers.ApiHelper.*;
import static org.junit.jupiter.api.Assertions.*;

@Slf4j
@DisplayName("Test PT AI 4.9.1 REST API calls that require scan")
@Tag("integration")
@Tag("scan")
@Environment(enabledFor = { V491 })
public class ScanTest extends com.ptsecurity.appsec.ai.ee.server.v491.AbstractTest {
    protected static UUID SCAN_RESULT_ID;

    @BeforeAll
    public static void init() {
        com.ptsecurity.appsec.ai.ee.server.v491.AbstractTest.init();
        com.ptsecurity.appsec.ai.ee.server.v491.AbstractTest.authenticate();
        com.ptsecurity.appsec.ai.ee.server.v491.AbstractTest.createTestProject();
        scan();
    }
