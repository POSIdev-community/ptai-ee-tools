...
import com.ptsecurity.appsec.ai.ee.server.v4110.api.model.*;
import com.ptsecurity.appsec.ai.ee.server.v4110.helpers.ApiHelper;
...
import static com.ptsecurity.appsec.ai.ee.server.v4110.api.model.Stage.*;
import static com.ptsecurity.appsec.ai.ee.server.v4110.helpers.ApiHelper.*;
import static org.junit.jupiter.api.Assertions.*;

@Slf4j
@DisplayName("Test PT AI 4.11.0 REST API calls that require scan")
@Tag("integration")
@Tag("scan")
@Environment(enabledFor = { V4110 })
public class ScanTest extends com.ptsecurity.appsec.ai.ee.server.v4110.AbstractTest {
    protected static UUID SCAN_RESULT_ID;

    @BeforeAll
    public static void init() {
        com.ptsecurity.appsec.ai.ee.server.v4110.AbstractTest.init();
        com.ptsecurity.appsec.ai.ee.server.v4110.AbstractTest.authenticate();
        com.ptsecurity.appsec.ai.ee.server.v4110.AbstractTest.createTestProject();
        scan();
    }
