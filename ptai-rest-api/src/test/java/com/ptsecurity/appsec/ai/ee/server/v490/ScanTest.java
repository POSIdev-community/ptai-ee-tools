package com.ptsecurity.appsec.ai.ee.server.v490;
...
import com.ptsecurity.appsec.ai.ee.server.v490.helpers.ApiHelper;
...
import static com.ptsecurity.appsec.ai.ee.server.v490.api.model.Stage.*;
import static com.ptsecurity.appsec.ai.ee.server.v490.helpers.ApiHelper.*;
import static org.junit.jupiter.api.Assertions.*;

@Slf4j
@DisplayName("Test PT AI 4.9.0 REST API calls that require scan")
@Tag("integration")
@Tag("scan")
@Environment(enabledFor = { V490 })
public class ScanTest extends com.ptsecurity.appsec.ai.ee.server.v490.AbstractTest {
    protected static UUID SCAN_RESULT_ID;

    @BeforeAll
    public static void init() {
        com.ptsecurity.appsec.ai.ee.server.v490.AbstractTest.init();
        com.ptsecurity.appsec.ai.ee.server.v490.AbstractTest.authenticate();
        com.ptsecurity.appsec.ai.ee.server.v490.AbstractTest.createTestProject();
        scan();
    }
