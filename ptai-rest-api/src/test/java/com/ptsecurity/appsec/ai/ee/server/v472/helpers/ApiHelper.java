package com.ptsecurity.appsec.ai.ee.server.v472.helpers;

import com.ptsecurity.appsec.ai.ee.server.helpers.AbstractApiHelper;
import com.ptsecurity.appsec.ai.ee.server.v472.api.ApiClient;
...
import com.ptsecurity.appsec.ai.ee.server.v472.auth.model.AuthScope;
...
public class ApiHelper extends AbstractApiHelper {
    ...
    public final static AuthApi AUTH = new AuthApi(new com.ptsecurity.appsec.ai.ee.server.v472.auth.ApiClient());
