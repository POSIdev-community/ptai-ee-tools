package com.ptsecurity.appsec.ai.ee.server.v481;
...
import com.ptsecurity.appsec.ai.ee.server.v481.api.ApiException;
...
import com.ptsecurity.appsec.ai.ee.server.v481.helpers.ApiHelper;
...
import static com.ptsecurity.appsec.ai.ee.server.v481.helpers.ApiHelper.*;
import static org.apache.http.HttpStatus.SC_BAD_REQUEST;
import static org.junit.jupiter.api.Assertions.*;

@Slf4j
@DisplayName("Test PT AI 4.8.1 REST API calls that do not require scan")
@Tag("integration")
@Environment(enabledFor = { V481 })
