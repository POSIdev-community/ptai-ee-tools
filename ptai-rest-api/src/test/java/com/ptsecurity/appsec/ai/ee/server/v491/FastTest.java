...
@Slf4j
@DisplayName("Test PT AI 4.9.1 REST API calls that do not require scan")
@Tag("integration")
@Environment(enabledFor = { V491 })
public class FastTest extends com.ptsecurity.appsec.ai.ee.server.v491.AbstractTest {
    @BeforeAll
