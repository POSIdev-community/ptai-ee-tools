package com.ptsecurity.appsec.ai.ee.server.v500.helpers;

import com.ptsecurity.appsec.ai.ee.server.helpers.AbstractApiHelper;
import com.ptsecurity.appsec.ai.ee.server.v500.api.ApiClient;
...
import com.ptsecurity.appsec.ai.ee.server.v500.auth.model.AuthScope;
...
public class ApiHelper extends AbstractApiHelper {
    ...
    public void authenticate() {
        for (TokenType tokenType : TokenType.values()) {
            ...
            if (ROOT == tokenType) {
                ...
                authResult = assertDoesNotThrow(AUTH::apiAuthSigninGet);
            }
    ...
    public final static AuthApi AUTH = new AuthApi(new com.ptsecurity.appsec.ai.ee.server.v500.auth.ApiClient());
    public final static ProjectsApi PROJECTS = new ProjectsApi(new ApiClient());
    public final static BranchesApi BRANCHES = new BranchesApi(new ApiClient());
