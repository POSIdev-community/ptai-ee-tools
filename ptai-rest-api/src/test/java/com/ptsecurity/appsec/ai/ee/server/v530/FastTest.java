package com.ptsecurity.appsec.ai.ee.server.v530;
...
import com.ptsecurity.appsec.ai.ee.server.v530.helpers.ApiHelper;
...
import static com.ptsecurity.appsec.ai.ee.scan.result.ScanBrief.ApiVersion.V530;
...
import static com.ptsecurity.appsec.ai.ee.server.v530.helpers.ApiHelper.*;
import static org.apache.http.HttpStatus.SC_BAD_REQUEST;
import static org.junit.jupiter.api.Assertions.*;

@Slf4j
@DisplayName("Test PT AI 5.3.0 REST API calls that do not require scan")
@Tag("integration")
@Environment(enabledFor = { V530 })
public class FastTest extends AbstractTest {
    ...
    public void getAllProjects() {
        List<ProjectModel> all = checkApiCall(() ->
                PROJECTS.apiProjectsGet(
                        /* limit = */ -1,
                        /* offset = */ -1),
                TokenType.CI);
