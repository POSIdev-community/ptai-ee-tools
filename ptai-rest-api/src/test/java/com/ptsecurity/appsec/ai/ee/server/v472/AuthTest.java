package com.ptsecurity.appsec.ai.ee.server.v472;

import com.ptsecurity.appsec.ai.ee.server.integration.rest.Environment;
import com.ptsecurity.appsec.ai.ee.server.v472.auth.ApiClient;
import com.ptsecurity.appsec.ai.ee.server.v472.auth.ApiException;
...
import static com.ptsecurity.appsec.ai.ee.scan.result.ScanBrief.ApiVersion.V472;
...
@Slf4j
@Tag("integration")
@Environment(enabledFor = { V472 })
@DisplayName("Test PT AI 4.7.2 authentication calls")
